...
function ENT:Draw()
    ...
    draw.SimpleTextOutlined("Techniques Katon", "NPCFont", 0, -20, Color(255, 255, 255), TEXT_ALIGN_CENTER, 0, 1.5, Color(0, 0, 0, 255))
...
local function drawTechniques ()
    ...
    frame:SetTitle("Techniques Katon - SL Community")
    frame:Center()
    frame:MakePopup()
    ...
    button1:SetText("C - La Balsamine")
    button1:SetSize(150, 30)
    button1:SetPos(50, 50)
    button1.DoClick = function()
        ply:ConCommand("say /advert *NA* Apprends La Balsamine (10 Minutes)")
        frame:Close()
    end

    local button2 = vgui.Create("DButton", frame)
    button2:SetText("C - Projectiles Enflammes")
    button2:SetSize(150, 30)
    button2:SetPos(275, 50)
    button2.DoClick = function()
        ply:ConCommand("say /advert *NA* Projectile enflammes (10 Minutes)")
        frame:Close()
    end

    local button3 = vgui.Create("DButton", frame)
    button3:SetText("B - Pluie de Breze")
    button3:SetSize(150, 30)
    button3:SetPos(500, 50)
    button3.DoClick = function()
        ply:ConCommand("say /advert *NA* Pluie de Breze (25 Minutes)")
        frame:Close()
    end

    local button4 = vgui.Create("DButton", frame)
    button4:SetText("B - Mur de Katon")
    button4:SetSize(150, 30)
    button4:SetPos(50, 100)
    button4.DoClick = function()
        ply:ConCommand("say /advert *NA* Mur de Katon (25 Minutes)")
        frame:Close()
    end

    local button5 = vgui.Create("DButton", frame)
    button5:SetText("B - Boule de feu supreme")
    button5:SetSize(150, 30)
    button5:SetPos(275, 100)
    button5.DoClick = function()
        ply:ConCommand("say /advert *NA* Boule de feu supreme (25 Minutes)")
        frame:Close()
    end

    local button6 = vgui.Create("DButton", frame)
    button6:SetText("A - Bombe de Feu")
    button6:SetSize(150, 30)
    button6:SetPos(500, 100)
    button6.DoClick = function()
        ply:ConCommand("say /advert *NA* Bombe de Feu (40 Minutes)")
        frame:Close()
    end

    local button7 = vgui.Create("DButton", frame)
    button7:SetText("A - Flamme des Enfers")
    button7:SetSize(150, 30)
    button7:SetPos(50, 150)
    button7.DoClick = function()
        ply:ConCommand("say /advert *NA* Flamme des Enfers (40 Minutes)")
        frame:Close()
    end

    local button8 = vgui.Create("DButton", frame)
    button8:SetText("A - Protection Infernale")
    button8:SetSize(150, 30)
    button8:SetPos(275, 150)
    button8.DoClick = function()
        ply:ConCommand("say /advert *NA* Protection Infernale (40 Minutes)")
        frame:Close()
    end

    local button9 = vgui.Create("DButton", frame)
    button9:SetText("S - Explosion Brulante")
    button9:SetSize(150, 30)
    button9:SetPos(500, 150)
    button9.DoClick = function()
        ply:ConCommand("say /advert *NA* Fait son entrainement pour obtenir la technique Explosion Brulante")
    ...
    button10:SetText("S - Tornade de Feu")
    button10:SetSize(150, 30)
    button10:SetPos(50, 200)
    button10.DoClick = function()
       ply:ConCommand("say /advert *NA* Fait son entrainement pour obtenir la technique Tornade de Feu")
        ply:ChatPrint("Vous devez faire un Passif de 3 Jours sur discord ainsi que de mettre ce message sur le serveur chaque jours de votre passif")
        frame:Close()
    end
end

net.Receive( "APPKATON", function()
    drawTechniques ()
end)